...
export const metadata: Metadata = {
  title: "Booking received · Adwizers Business Carnival 2026",
  robots: { index: false },
};

const STEPS = [
  "Our team reviews your booking and may reach out on WhatsApp if anything is missing.",
  `Because each category carries only one business, we confirm whether your space is available before anything is due. Only then do we share the ${STALL_FEE_DISPLAY} payment details.`,
  `Once payment is settled, your space at ${CARNIVAL_EVENT.venue} on ${CARNIVAL_EVENT.date} is held for you, and we start promoting your business ahead of the day.`,
];

export default function CarnivalThankYouPage() {
  return (
    <DarkShell>
        ...
        >
          ...
          <div className="animate-rise p-5 sm:p-8 lg:p-10">
            ...
            <h1 className="mt-5 text-xl font-semibold tracking-tight text-heading sm:text-2xl md:text-3xl">
              Thank you — we have your booking
            </h1>
            <p className="mt-2.5 text-sm leading-relaxed text-ink-muted sm:text-[15px]">
              Your request for a business space at the Adwizers Business Carnival 2026 is with us.
